...
export const responseGenerate = async (data: IMainForm, setMessage: any) => {
  const completeOptions = {
    prompt: `Write an amazing and praising sentence for a finalist who had struggled their 5 years journey through university in the department of pure and applied biology with the following biodata with emoji 
